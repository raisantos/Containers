...
int main(int argc, const char * argv[]) {
	...
	q->getPilha()->setIndice(1); //indeice 1 destino
	while(l != NULL){
		...
		q->getPilha()->setIndice(1);//lista2 andou, lista 1 andar tbm, para mudar o indice destino e deixar antigo alvo temporario
	}
